# SparkyPod LLM Benchmark Report
...
- max_tokens: 4096 (matches SparkyPod production)
- response_format: json_object (with prompt-injection fallback when provider rejects native)
- Window size: 10 min, overlap: 3 min (imported from SparkyPod's create_windows)
