...
# Grafana MCP queries against {container="sparkypod"} for the time window of
...
#   {container="sparkypod"} |~ "sk-ant-|sk-proj-|xoxb-|Bearer "
#   {container="sparkypod"} |~ "Traceback"
#   {container="sparkypod"} |~ "ssrf_blocked"
#   {container="sparkypod"} |~ "(\\?|&)(api[_-]?key|token|secret|password)="
set -euo pipefail
